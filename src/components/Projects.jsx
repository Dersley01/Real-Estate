...
const Projects = () => {
  ...
  return (
    <motion.div
      ...
      <p className='text-center text-gray-500 mb-8 mx-auto'>Crafting Spaces, Building History-Explore Our Portfolio</p>
                    ...
                    <div className='absolute bottom-5 left-0 right-0 flex justify-center'>
                        <div className='inline-block bg-white w-3/4 px-4 py-2 shadow-md'>
                          ...
                          <p className='text-gray-500 text-sm'>
                            {project.price} <span className='px-.7'></span>{project.location}
                          </p>
                        </div>
                    </div>
                </div>
