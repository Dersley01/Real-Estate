...
const Testimonials = () => {
  return (
    <motion.div
      ...
      <p className='text-center text-gray-500 mb-12 max-w-80 mx-auto'>What our customers are saying about us</p>
      ...
      <div className='flex flex-wrap justify-center gap-8'>
        {testimonialsData.map((testimonial, index) => (
            <div key={index} className='max-w-[340px] border rounded shadow-lg px-8 py-12 text-center'>
              ...
              <div className='flex justify-center gap-1 text-red-500 mb-b'>
